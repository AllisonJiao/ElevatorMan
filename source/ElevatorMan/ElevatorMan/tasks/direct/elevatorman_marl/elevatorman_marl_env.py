...
from .elevatorman_marl_env_cfg import ElevatormanMarlEnvCfg


class ElevatormanMarlEnv(DirectMARLEnv):
    cfg: ElevatormanMarlEnvCfg

    def __init__(self, cfg: ElevatormanMarlEnvCfg, render_mode: str | None = None, **kwargs):
